...
class Model(nn.Module):
    ...
    def IMTS_Model(self, x, mask_X):
        ...
        actual_batch_size = x_patch.shape[0] // (self.ndim * self.n_patch)
        x_patch = x_patch.view(actual_batch_size, self.ndim, self.n_patch, -1)
