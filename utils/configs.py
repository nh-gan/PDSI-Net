...
parser.add_argument('--astgi_k_neighbors', type=int, default=64,
                    help='Number of original KNN neighbors retained by KDCG.')
...
parser.add_argument('--astgi_channel_dist_weight', type=float, default=1.0,
                    help='Weight (w_c) for the KNN/KDCG channel-coordinate distance.')
parser.add_argument('--use_dc_enhance', type=int, choices=[0, 1], default=1,
                    help='Enable residual distance-correlation KNN enhancement.')
parser.add_argument('--use_newsp', type=int, choices=[0, 1], default=1,
                    help='Enable the residual NewSP adaptive hypergraph branch.')
parser.add_argument('--lambda_dc', type=float, default=0.1,
                    help='Initial learnable residual graph correction strength.')
parser.add_argument('--num_hyperedges', type=int, default=16,
                    help='Number of adaptive NewSP hyperedges.')
parser.add_argument('--hyper_temperature', type=float, default=0.5,
                    help='Temperature used by NewSP hyperedge assignment.')
parser.add_argument('--hyper_warmup_epochs', type=int, default=20,
                    help='Epochs using only the original ASTGI graph branch.')
parser.add_argument('--rastgi_debug', type=int, choices=[0, 1], default=0,
                    help='Print RASTGI-HG graph and gate diagnostics every 10 epochs.')
